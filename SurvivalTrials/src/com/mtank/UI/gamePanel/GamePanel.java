		...
		for (int i = 0; i < canvas.world.length; i++) {
			for (int j = 0; j < canvas.world[0].length; j++) {
				...
				if (canvas.world[j][i].creature != null && canvas.world[j][i].creature.creatureType != 0) {
					...
					drawItem(workingCanvas, Stringify.item(canvas.world[j][i].item.get(0)), 0,_landType);
				} else {
		...
		for (int i = 0; i < canvas.world.length; i++) {
			for (int j = 0; j < canvas.world[0].length; j++) {
				...
				if (canvas.world[j][i].creature != null && canvas.world[j][i].creature.creatureType != 0) {
					...
					drawItem(something, Stringify.item(canvas.world[j][i].item.get(0)), 0,_landType);
				} else {
